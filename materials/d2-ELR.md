...
| 9. | **Publish or Perish** | Publish or Perish is a software program that retrieves and analyzes academic citations. It uses various publicly available data sources to obtain the raw citations, then analyzes these and calculates a series of citation metrics. | <a href="https://harzing.com/resources/publish-or-perish" ><img src="../images/article.png" width="24px" height="24px" ></a> |
